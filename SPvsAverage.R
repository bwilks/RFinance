...
GSPC<-fread("https://query1.finance.yahoo.com/v7/finance/download/%5EGSPC?period1=-631152000&period2=1666396800&interval=1wk&events=history&includeAdjustedClose=true")
...
years<-data.frame("year"= seq(as.Date("1950/01/01"), by = "year", length.out = 74) ,"yearprice"=c(1950:2023))
